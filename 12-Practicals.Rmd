...
Clone the newly forked folder to your local machine: 

```{bash, eval = FALSE}
git clone https://github.com/femeunier/VegMod_course.git
```

or using SSH (to set up first, see for instance https://help.github.com/en/github/authenticating-to-github/connecting-to-github-with-ssh)
...
Open the PR online by visiting your github repository.
