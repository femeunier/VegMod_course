...
{\centering \includegraphics[width=0.8\linewidth]{VegMod_course_files/figure-latex/nice-fig-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{'figures/Figure_course.png'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\chapter{Modelling basic processes for growth and the carbon cycle
(fluxes)}\label{modelling-basic-processes-for-growth-and-the-carbon-cycle-fluxes}

\part{Modelling stand
dynamics}\label{part-modelling-stand-dynamics}

\chapter{Modelling growth, timber production and
C-allocation}\label{modelling-growth-timber-production-and-c-allocation}

\chapter{Modelling vegetation dynamics and
demography}\label{modelling-vegetation-dynamics-and-demography}

\part{Dynamic vegetation
modelling}\label{part-dynamic-vegetation-modelling}
...
\subsection{Plant functional types,}\label{plant-functional-types}

\subsection{Trait based models}\label{trait-based-models}

\section{Competition models (competition and coexistence of
species/PFTs)}\label{competition-models-competition-and-coexistence-of-speciespfts}
