...
```{r f1, fig.cap='The planetary boundaries (www.stockholmresilience.org)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE}
...
```{r f5, fig.cap='Continuum of terrestrial biosphere/ecosystem models. (Bonan 2019)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE}
knitr::include_graphics('figures/chap1/table_model_types.png')
```

```{r f6, fig.cap='Continuum of process-based versus empirical models. (Adams et al. 2013)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE}
...
```{r f8, fig.cap='Definition of key model components and examples for a typical TBM', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE}
knitr::include_graphics('figures/chap1/table_components.png')
```

```{r f9, fig.cap='Structure of a vegattion model indicating the different time steps at which each process is simulated (Williams et al. 2009)', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE}
